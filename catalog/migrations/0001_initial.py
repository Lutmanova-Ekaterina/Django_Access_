    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sing_of_publication',
                 models.CharField(choices=[('active', 'Опубликован'), ('inactive', 'Не опубликован')], default='active',
                                  max_laugth=250, verbose_name='Признак публикации')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status',
                 models.CharField(choices=[('active', 'активная'), ('inactive', 'неактивная')], default='inactive',
                                  max_length=50, verbose_name='Признак версии')),
